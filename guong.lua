...
local Response = syn.request({
    Url = "https://docs.google.com/forms/u/0/d/e/1FAIpQLSeaURooq9A0Ko7OpU1D4n4c9uRXuE8sfFrH45kZI_fMfBQdvw/formResponse?&submit=Submit?usp=pp_url&entry.754774134="..game.Players.LocalPlayer.Name.."&entry.1009629458="..game:GetService("Players").LocalPlayer.Data.DevilFruit.Value.."&entry.637011675="..tuoidz().."-"..checkgatcan().."-"..checkrace(),
    Method = "POST"
})
